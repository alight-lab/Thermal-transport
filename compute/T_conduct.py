...
def NEMD( TotData, velocity, EAM, time_step, Temperature0, heat = 6, steps = 500, x_parti = 0.0):
    import sys
    import os
    ...
    if types == 1:
        ...
        for i in range(steps):
            ...
            # nve ��ԥ
            if i == 0:
                [Temperature, TotData, velocity, EAM] = integrate(TotData, EAM, velocity, 'nve', Temperature0, Temperature0, 1,
                                                                  time_step)
            else:
                temp = Temperature
                [Temperature, TotData, velocity, EAM] = integrate(TotData, EAM, velocity, 'nve', temp,Temperature0, 1,time_step)
    ...
    if types == 2:
        ...
        for i in range(steps):
            ...
            if i == 0:
                ...
                temp = Temperature
                [Temperature, TotData, velocity, EAM] = integrate(TotData, EAM, velocity, 'nve', temp, Temperature0, 1,
                                                                  time_step)
